  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gray-100 relative">
      ...
      <div className="w-full max-w-md bg-white/80 backdrop-blur border border-gray-200 rounded-3xl shadow-xl p-8 space-y-6 z-10">
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full appearance-none bg-gray-50 border-2 border-gray-300 rounded-xl pl-12 pr-12 py-4 font-medium text-gray-900
        ...
        {/* STEP 1 */}
        <div className={`${step === 1 ? "block" : "hidden"} space-y-5`}>
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-50 border-2 border-gray-300 rounded-xl pl-12 pr-4 py-4 text-gray-900
                         focus:border-indigo-500 focus:ring-4 focus:ring-indigo-200"
            />
          </div>
          ...
          <button
            ...
            className="w-full py-4 rounded-xl font-bold text-white bg-indigo-600 hover:bg-indigo-700
        ...
        {/* STEP 2 */}
        <div className={`${step === 2 ? "block" : "hidden"} space-y-5`}>
          <button
            onClick={() => setStep(1)}
